#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Axiom Matugen TUI - Dynamic TOML Manager
...
# =============================================================================
# ▼ AXIOM MATUGEN TUI - CONFIGURATION GUIDE ▼
# =============================================================================
...
register_items() {
    ...
    register_template 1 "Axiom Control"  "axiom_control_center" "true" ""
    register_template 1 "Axiom Sliders"  "axiom_sliders"        "true" ""
