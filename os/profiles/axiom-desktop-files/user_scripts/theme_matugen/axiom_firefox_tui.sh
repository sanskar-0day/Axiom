#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Axiom Firefox Theme Manager - Master v1.5.0
# -----------------------------------------------------------------------------
...
declare -r APP_TITLE="Axiom Firefox Themer"
declare -r APP_VERSION="v1.5.0 (Stable)"

declare -r REPO_URL="https://github.com/dim-ghub/axiom-websites/archive/refs/heads/main.tar.gz"
declare -r CACHE_DIR="${XDG_CACHE_HOME:-$HOME/.cache}/axiom_themer"
...
deploy_changes() {
    ...
    # 3. Append existing content (excluding legacy axiom imports and old colors.css imports)
