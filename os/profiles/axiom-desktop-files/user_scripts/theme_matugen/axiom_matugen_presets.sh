#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Axiom Matugen Presets v4.0.5 (Matugen V2 Aligned)
# -----------------------------------------------------------------------------
...
declare -r APP_TITLE="Axiom Matugen Presets"
declare -r APP_VERSION="v4.0.5"

# --- State & Favorites Paths ---
declare -r USE_STATE_FILE=true
declare -r STATE_DIR="${HOME}/.config/axiom/settings/axiom_theme"
...
save_favorites() {
    ...
    printf '# Axiom Matugen Favorites\n' > "$tmpfile"
