...
readonly TARGET_FILES=(
    ...
    "axiom_appearances.desktop"
    "axiom_battery_notify.desktop"
    "axiom_control_center.desktop"
    "axiom_hyprlock_switcher.desktop"
    "axiom_hypridle_timeout.desktop"
    "axiom_hypridle_toggle.desktop"
    "axiom_input.desktop"
    "axiom_gsettings.desktop"
    "axiom_keybinds.desktop"
    "axiom_monitor.desktop"
    "axiom_matugen_presets.desktop"
    "axiom_network.desktop"
    "axiom_power.desktop"
    "axiom_waybars.desktop"
    "axiom_wayclick_config.desktop"
    "axiom_window_rules.desktop"
    "axiom_workspace_manager.desktop"
    "axiom_site_blocker.desktop"
    "axiom_sliders.desktop"
    "axiom_service_toggle.desktop"
