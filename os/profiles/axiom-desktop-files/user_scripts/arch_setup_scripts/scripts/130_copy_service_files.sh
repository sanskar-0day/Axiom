...
readonly SERVICES_CONFIG=(
    ...
    # Axiom Control Center Daemon (Default: Disable)
    "$HOME/user_scripts/axiom_system/control_center/service/axiom.service | disable"

    # axiom update checker
    "$HOME/user_scripts/update_axiom/update_checker/service/update_checker.service | disable"
    "$HOME/user_scripts/update_axiom/update_checker/service/update_checker.timer | enable"

    # axiom sliders
    "$HOME/user_scripts/sliders/service/axiom_sliders.service | disable"
