...
# Purpose: Forcefully manages the Axiom Sliders lifecycle.
...
# Configuration
# -----------------------------------------------------------------------------
readonly APP_NAME="Axiom Sliders"
readonly SERVICE_NAME="axiom_sliders.service"
readonly PROCESS_PATTERN='axiom_sliders\.py'
readonly GUI_SCRIPT_PATH="${HOME}/user_scripts/sliders/axiom_sliders.py"
