#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Axiom TUI Engine - Master v4.4.1 (Ultimate Hyprland 0.54 Edition)
# -----------------------------------------------------------------------------
...
declare -r APP_TITLE="Axiom Workspace Manager"
    ...
    if [[ ! -f "${CONFIG_FILE}" || ! -s "${CONFIG_FILE}" ]]; then
        {
            ...
            printf '# Managed by Axiom TUI - Granular Matrix v4.4.1\n'
            printf '# ==============================================================================\n\n'
