#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Axiom Appearances - Elite Edition v7.8.0 (Engine Sync + Streamlined Gaps)
# -----------------------------------------------------------------------------
# Target: Arch Linux / Hyprland / UWSM / Wayland
# Description: Tabbed TUI to modify hyprland appearance.conf.
# Engine: Synced with Axiom TUI Engine Master v3.9.1
# -----------------------------------------------------------------------------
...
declare -r APP_TITLE="Axiom Appearances"
